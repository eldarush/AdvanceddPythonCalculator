...
def test_complicated_equations():
    ...
    assert calculate_equation("(~-----(321312*32)%2^31)*76 -- (5---321 +(21)!)") == "5.109094217170944e+19"
    ...
    assert calculate_equation("(8 *8 @  8%8#+8!  ^8/8+88)---   (77^0.77@ 77#-77* 7.7)")  == "8.73120530892689e+35"
    assert calculate_equation("(  324%3-  (31^2-19!%89-432+3@1)  *0.69420+  (5^435@1) )  ^0.00069420")  == "1.2757895631250789"
    ...
    assert calculate_equation("((--(-1-  (-2%6  ^7&6)- -0.89)+3  #/2)--1) @1@1@1@2--8$7") ==  "-246.41312499999998"
